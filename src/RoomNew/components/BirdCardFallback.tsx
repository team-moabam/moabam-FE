const BirdCardFallback = () => {
  return (
    <div className="flex grow animate-pulse cursor-pointer select-none flex-col items-center justify-center rounded-xl bg-white p-4 text-black dark:bg-dark-sub dark:text-white">
